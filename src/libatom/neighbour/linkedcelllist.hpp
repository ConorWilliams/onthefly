...
//    * which contains the active atoms, boundary atoms and any ghost atoms required if the
//    supercell
//    * is periodic.
//    *
//    * @tparam Data a fundamental, trivially_destructible, default_constructible, assignable type
//    that
...
//      *
//      * After constructing a LinkedCellList you will be able to iterate over all pairs of
//      neighbours
...
//     /**
//      * @brief Build the linked cell list, binning atoms into orthogananl cells (min "rcut" in
//      each
//      * dimension).
//      *
...
//   //   template <typename Data> void LinkedCellList<Data>::load(double rcut, Supercell const
//   &cell)
//   //   {
