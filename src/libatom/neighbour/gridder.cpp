...
//           for (auto i : {-1, 0, 1}) {
//             if (i != 0 || j != 0 || k != 0) {
//               offsets[idx++] = (Vec<int>{i, j, k} * m_prod_shape).sum();
//             }
//           }
//         } else {
//           if (j != 0 || k != 0) {
//             offsets[idx++] = (Vec<int>{j, k} * m_prod_shape).sum();
//           }
//         }
//       }
//     }
...
//               auto lam = (Vec<int>{i, j, k} * m_prod_shape).sum();
...
//         for (int j = 1; j < m_shape[1] - 1; j++) {
//           for (std::size_t n = 0; n < offsets.size(); n++) {
//             auto lam = (Vec<int>{i, j} * m_prod_shape).sum();
