...
- Replace all occurrences of "OnTheFly" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `OnTheFly` means the name of the project, while `onthefly` is used in file names.
  - Remember to rename the `include/onthefly` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
