...
TEST_CASE("Gridder") {
  ...
  REQUIRE(grid.cell_idx(otf::Vec<otf::flt_t>{0, 0, 0} + grid.origin()) == 1 + 1 * 5 + 1 * 5 * 5);
  REQUIRE(grid.cell_idx(otf::Vec<otf::flt_t>{0, 0, 0} + grid.origin()) == 1 + 1 * 5 + 1 * 5 * 5);

  REQUIRE(grid.cell_idx(otf::Vec<otf::flt_t>{5, 5, 5} + grid.origin()) == 2 + 2 * 5 + 2 * 5 * 5);

  REQUIRE(grid.cell_idx(otf::Vec<otf::flt_t>{9.999, 9.999, 9.999} + grid.origin())
          == 3 + 3 * 5 + 3 * 5 * 5);
